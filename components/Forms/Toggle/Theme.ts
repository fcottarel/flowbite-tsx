...
export const ToggleTheme: ToggleThemeType = {
    container: "inline-flex items-center cursor-pointer",
    input: "sr-only peer",
    label: "ms-3 text-sm font-medium text-gray-900 dark:text-gray-300",
