...
export const TextareaTheme: TextareaThemeType = {
    base: "block p-2.5 w-full text-sm rounded-lg border text-gray-900 bg-gray-50 border-gray-300 dark:border-gray-600 dark:placeholder-gray-400 ",
    colors: {
